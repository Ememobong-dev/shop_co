...
export const Testimonial = ({
  ...
  return (
    <div className={`flex flex-col gap-y-4  border rounded-lg  h-[250px] border-black/10 p-7  ${variant === "customer" ? "!w-[500px] shrink-0" : "w-full"} `}>
      ...
      <p className="text-black/60 text-base font-satoshi-med font-normal">{date}</p>
    </div>
  );
};
